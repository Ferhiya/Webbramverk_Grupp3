...
Revision ID: fffb0f5ea15f
Revises: 
Create Date: 2025-02-10 11:37:16.032389
...
def upgrade():
    ...
    op.create_table('NewsletterSubscribers',
    sa.Column('SubscriberID', sa.Integer(), nullable=False),
    sa.Column('email', sa.String(length=120), nullable=False),
    sa.Column('DateSubscribed', sa.DateTime(), nullable=True),
    sa.Column('IsActive', sa.Boolean(), nullable=True),
    sa.PrimaryKeyConstraint('SubscriberID'),
...
def downgrade():
    ...
    op.drop_table('NewsletterSubscribers')
